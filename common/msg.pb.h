...
constexpr ExchangeType ExchangeType_MAX = TOP;
...
enum DeliverMode : int {
  UNKNOWNMODE = 0,
  UNDURABLE = 1,
  DURABLE = 2,
  DeliverMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  DeliverMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool DeliverMode_IsValid(int value);
constexpr DeliverMode DeliverMode_MIN = UNKNOWNMODE;
constexpr DeliverMode DeliverMode_MAX = DURABLE;
constexpr int DeliverMode_ARRAYSIZE = DeliverMode_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* DeliverMode_descriptor();
template<typename T>
inline const std::string& DeliverMode_Name(T enum_t_value) {
  static_assert(::std::is_same<T, DeliverMode>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function DeliverMode_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    DeliverMode_descriptor(), enum_t_value);
}
inline bool DeliverMode_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DeliverMode* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DeliverMode>(
    DeliverMode_descriptor(), name, value);
}
// ===================================================================
...
class BasicProperties final :
 ...
 public:
  ...
  // .mq.DeliverMode delivery_mode = 2;
  void clear_delivery_mode();
  ::mq::DeliverMode delivery_mode() const;
  void set_delivery_mode(::mq::DeliverMode value);
  private:
  ::mq::DeliverMode _internal_delivery_mode() const;
  void _internal_set_delivery_mode(::mq::DeliverMode value);
  public:
...
class Message final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::mq::Message_Payload* release_payload();
...
inline ::mq::DeliverMode BasicProperties::_internal_delivery_mode() const {
  return static_cast< ::mq::DeliverMode >(delivery_mode_);
}
inline ::mq::DeliverMode BasicProperties::delivery_mode() const {
  // @@protoc_insertion_point(field_get:mq.BasicProperties.delivery_mode)
  return _internal_delivery_mode();
}
inline void BasicProperties::_internal_set_delivery_mode(::mq::DeliverMode value) {
  
  delivery_mode_ = value;
}
inline void BasicProperties::set_delivery_mode(::mq::DeliverMode value) {
...
inline const std::string& Message_Payload::valid() const {
  // @@protoc_insertion_point(field_get:mq.Message.Payload.valid)
...
void Message_Payload::set_valid(ArgT0&& arg0, ArgT... args) {
 ...
 valid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:mq.Message.Payload.valid)
}
inline std::string* Message_Payload::mutable_valid() {
  std::string* _s = _internal_mutable_valid();
  // @@protoc_insertion_point(field_mutable:mq.Message.Payload.valid)
  return _s;
}
...
inline std::string* Message_Payload::release_valid() {
  // @@protoc_insertion_point(field_release:mq.Message.Payload.valid)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:mq.Message.Payload.valid)
}
...
inline ::mq::Message_Payload* Message::_internal_mutable_payload() {
  ...
  if (payload_ == nullptr) {
    auto* p = CreateMaybeMessage<::mq::Message_Payload>(GetArenaForAllocation());
    payload_ = p;
  }
  return payload_;
}
inline ::mq::Message_Payload* Message::mutable_payload() {
  ::mq::Message_Payload* _msg = _internal_mutable_payload();
...
inline const std::string& Message::valid() const {
  // @@protoc_insertion_point(field_get:mq.Message.valid)
  return _internal_valid();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Message::set_valid(ArgT0&& arg0, ArgT... args) {
 ...
 valid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:mq.Message.valid)
}
inline std::string* Message::mutable_valid() {
  std::string* _s = _internal_mutable_valid();
  // @@protoc_insertion_point(field_mutable:mq.Message.valid)
  return _s;
}
...
inline std::string* Message::release_valid() {
  // @@protoc_insertion_point(field_release:mq.Message.valid)
  return valid_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:mq.Message.valid)
}
...
template <> struct is_proto_enum< ::mq::DeliverMode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mq::DeliverMode>() {
  return ::mq::DeliverMode_descriptor();
}
